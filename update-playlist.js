...
// --- 🌐 CONFIGURATION: Domain change hone par bas yahan change karna hai ---
const MAIN_SITE = "https://watchomovies.forum/";
...
// Category aur uska Group Title
const categories = [
    { path: 'genre/brazzers/', group: '🔞18+' }
];
